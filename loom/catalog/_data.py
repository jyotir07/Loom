"""Default in-memory catalog data — providers, modalities, models.

Schema per model entry:
    {
        "id":     str  - stable identifier sent in by the caller
        "name":   str  - human-readable label
        "model":  str  - (optional) real upstream model ID; defaults to "id"
...
update the "model" field on the relevant entry; no other code
